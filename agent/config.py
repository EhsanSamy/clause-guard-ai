...
class ModelConfig:
    ...
    reflection_model: str = os.getenv("REFLECTION_MODEL", "claude-sonnet-4-5")
    report_model: str = os.getenv("REPORT_MODEL", "claude-sonnet-4-5")
...
class GuardrailConfig:
    # Flag strings used consistently across nodes so tests can assert on them.
